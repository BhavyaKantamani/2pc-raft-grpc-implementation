...
class RaftServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.NotifyLeader = channel.unary_unary(
                '/raft.RaftService/NotifyLeader',
                request_serializer=raft__pb2.NotifyLeaderRequest.SerializeToString,
                response_deserializer=raft__pb2.Ack.FromString,
                _registered_method=True)
        self.ClientOperation = channel.unary_unary(
                '/raft.RaftService/ClientOperation',
...
class RaftServiceServicer(object):
    ...
    def ClientOperation(self, request, context):
        """Missing associated documentation comment in .proto file."""
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details('Method not implemented!')
        raise NotImplementedError('Method not implemented!')
...
def add_RaftServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'NotifyLeader': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=raft__pb2.NotifyLeaderRequest.FromString,
                    response_serializer=raft__pb2.Ack.SerializeToString,
            ),
            'ClientOperation': grpc.unary_unary_rpc_method_handler(
                    servicer.ClientOperation,
...
class RaftService(object):
    ...
    def NotifyLeader(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/raft.RaftService/NotifyLeader',
            raft__pb2.NotifyLeaderRequest.SerializeToString,
            raft__pb2.Ack.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
